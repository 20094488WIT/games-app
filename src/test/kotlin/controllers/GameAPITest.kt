...
class GameAPITest {
    ...
    private var learnKotlin: Game? = null
    private var summerHoliday: Game? = null
    private var codeApp: Game? = null
    private var testApp: Game? = null
    private var swim: Game? = null
    private var populatedNotes: GameAPI? = GameAPI(XMLSerializer(File("notes.xml")))
    private var emptyNotes: GameAPI? = GameAPI(XMLSerializer(File("notes.xml")))
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            ...
            assertEquals(newGame, populatedNotes!!.findNote(populatedNotes!!.numberOfNotes() - 1))
        }
        ...
        fun `adding a Note to an empty list adds to ArrayList`() {
            ...
            assertEquals(newGame, emptyNotes!!.findNote(emptyNotes!!.numberOfNotes() - 1))
        }
    }
    ...
    inner class PersistenceTests {
        ...
        fun `saving and loading an empty collection in XML doesn't crash app`() {
            ...
            val storingNotes = GameAPI(XMLSerializer(File("notes.xml")))
            storingNotes.store()

            //Loading the empty notes.xml file into a new object
            val loadedNotes = GameAPI(XMLSerializer(File("notes.xml")))
            loadedNotes.load()
        ...
        fun `saving and loading an empty collection in JSON doesn't crash app`() {
            ...
            val storingNotes = GameAPI(JSONSerializer(File("notes.json")))
            storingNotes.store()

            //Loading the empty notes.json file into a new object
            val loadedNotes = GameAPI(JSONSerializer(File("notes.json")))
            loadedNotes.load()
